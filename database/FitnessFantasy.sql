...
INSERT INTO UserInfo (username, pwd, email, height, weight)
	VALUES 
...
INSERT INTO UserRepetitions (username, squat, pushup, crunches, pullup, dips)
	VALUES 
		('Balaise', 5, 8, 20, 3, 7);
...
INSERT INTO Exercise (exerciseName, muscle1, muscle2, muscle3, explanation)
	VALUES 
        ...
        ('Knee Rolls','Core','Back','Adductors','Lie on your back. Roll your knees to one side, followed by your pelvis, keeping both shoulders on the floor. Hold the stretch for one deep breath and return to the starting position. Change side.'),
...
INSERT INTO Quests (username, exercise, runningtime, stretchingtime, period)
	VALUES ('Balaise', 30, 5200, 10, '2020-12-09');

SET SQL_SAFE_UPDATES = 0;
DELETE FROM Quests;
SELECT * FROM UserInfo;
SELECT * FROM UserRepetitions;
